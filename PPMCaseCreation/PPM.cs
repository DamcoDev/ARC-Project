...
namespace PPMCaseCreation
{
    public class PPM:CodeActivity
    {
        //[Input("PPM Case Setup")]
        //[RequiredArgument]
        //[ReferenceTarget("itscs_ppmcasesetup")]
        //public InArgument<EntityReference> PPMCase { get; set; }
        ...
        protected override void Execute(CodeActivityContext context)
        {
            ...
            //    return;
            //}
            Guid PPMCaseSetupGuid = Contract.Get<EntityReference>(context).Id;
            executeBusinessLogic(PPMCaseSetupGuid, service);
        }
